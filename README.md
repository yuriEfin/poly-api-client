...
**Free** (ключ не нужен): коллекции, отправка запросов, скрипты, **импорт Postman и cURL**.

На сайте и в списке возможностей на август 2026 также указаны OpenAPI и другие спецификации на Free. В карточке Chrome Web Store по-прежнему написано, что расширенный импорт спецификаций открывается на платных планах. **Актуальный список сверяйте на [сайте](https://polyapiclient.ru/features)** — витрины могли расходиться.
...
Мы не «убийца Postman» и не замена Bruno.
