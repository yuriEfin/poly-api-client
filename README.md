...
**PolyApiIDE** — расширение для [Google Chrome](https://chromewebstore.google.com/detail/polyapiide/jladdfejldmbglilemedogoeceohbbmb)
- Website: [polyapiclient.ru](https://polyapiclient.ru/) (подойдут и другие браузеры на Chromium, в том числе Microsoft Edge): клиент для запросов к API (программный интерфейс приложения) **прямо во вкладке браузера**. Это не десктоп-программа и не обязательное облако.
